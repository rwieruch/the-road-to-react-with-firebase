...
That way, consumers (React components in our case) should be only allowed to access the *index.js* file as the sole interface to the whole Firebase module (*src/firebase/*), and should not access the auth or firebase files directly.
